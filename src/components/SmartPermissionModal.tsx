          ...
          <div className="flex flex-col">
            ...
            <div className="p-10 text-center space-y-8">
              ...
              <div className="flex items-center gap-4 p-4 bg-secondary/30 rounded-2xl border border-dashed">
                 ...
                 <p className="text-[10px] font-bold text-left leading-relaxed opacity-60 uppercase tracking-tight">
                   Standard browser verification will follow. Your data remains encrypted and isolated.
                 </p>
              </div>
